...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "caa.db")
...
class CaaSpider(Spider):
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS caa_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO caa_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM caa_data")
