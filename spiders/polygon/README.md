# Polygon.io API Spider

Automated data collection for Polygon.io API.
...
├── data/
│   └── polygon.db          # SQLite database
└── output/
    ├── polygon_items.jsonl        # Streaming JSONL
    └── polygon_complete.json       # Consolidated export
```

## Database Schema

**Table:** `polygon_api_info`
...
|----------|---------|-------------|
| DB_PATH | ./data/polygon.db | Custom database path |
...
*Generated by FindData DaaS • Score: 90/100 • Status: Ready for deployment*
