...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "bls.db")
...
class BlsSpider(Spider):
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS bls_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO bls_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM bls_data")
