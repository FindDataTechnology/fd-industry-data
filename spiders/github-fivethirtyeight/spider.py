...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "github-fivethirtyeight.db")
...
NAME = "github-fivethirtyeight"

class GithubfivethirtyeightSpider(Spider):
    name = "github-fivethirtyeight"
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS github-fivethirtyeight_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO github-fivethirtyeight_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM github-fivethirtyeight_data")
...
if __name__ == "__main__":
    ...
    spider_instance = GithubfivethirtyeightSpider()
