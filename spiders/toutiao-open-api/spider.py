...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "toutiao-open-api_records".replace("-", "_")
...
def run_spider(urls: Optional[List[str]] = None, save_results: bool = True) -> List[Dict[str, Any]]:
    ...
    logger.info("Score priority: HIGH ({}))".format(98))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for 今日头条开放平台")
