#!/usr/bin/env python3
"""
Ministry of Education Spider - Scraping Implementation
http://www.moe.gov.cn/
...
logger = logging.getLogger("ministryofeducation")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "ministryofeducation.db"
