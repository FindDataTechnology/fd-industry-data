...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "chinamonitor.db")
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "output")

START_URLS = [
    "https://www.chinamonitor.com.cn/",
]
CUSTOM_UAS = [
...
class ChinamonitorSpider(Spider):
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS chinamonitor_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO chinamonitor_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM chinamonitor_data")
...
if __name__ == "__main__":
    ...
    spider_instance = ChinamonitorSpider()
