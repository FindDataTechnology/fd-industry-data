#!/usr/bin/env python3
"""Awesome China Dataset Repository Scrapling Spider."""
...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "github_records".replace("-", "_")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for Awesome China Dataset Repository")
