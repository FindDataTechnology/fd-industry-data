...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "inmetals.db")
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "output")

START_URLS = [
    "https://www.inmetals.com",
]
CUSTOM_UAS = [
...
class InmetalsSpider(Spider):
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS inmetals_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO inmetals_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM inmetals_data")
...
if __name__ == "__main__":
    ...
    spider_instance = InmetalsSpider()
