...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "kunfloralexport.db")
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "output")

START_URLS = [
    "https://www.kunfloralexport.com",
]
CUSTOM_UAS = [
...
NAME = "kunfloralexport"

class KunfloralexportSpider(Spider):
    name = "kunfloralexport"
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS kunfloralexport_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO kunfloralexport_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM kunfloralexport_data")
...
def run_kunfloralexport(urls=None, save=True):
    """Run the kunfloralexport spider. Returns True on success."""
    spider = KunfloralexportSpider()
...
if __name__ == "__main__":
    ...
    spider_instance = KunfloralexportSpider()
