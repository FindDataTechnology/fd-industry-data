#!/usr/bin/env python3
"""
S&P Global Commodity Insights (Metal Bulletin) Spider - Scraping Implementation
...
logger = logging.getLogger("spglobalcommodityinsightsmeta")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "spglobalcommodityinsightsmeta.db"
...
def run_spglobalcommodityinsightsmeta():
    conn = init_db()
    result = {"items": [], "errors": []}
...
if __name__ == "__main__":
    run_spglobalcommodityinsightsmeta()
