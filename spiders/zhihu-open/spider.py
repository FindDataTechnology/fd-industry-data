#!/usr/bin/env python3
"""Zhihu Open Platform Scrapling Spider."""
...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "zhihu-open_records".replace("-", "_")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for Zhihu Open Platform")
