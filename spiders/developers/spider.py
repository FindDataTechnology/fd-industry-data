#!/usr/bin/env python3
"""WeChat Open Platform Official Documentation Scrapling Spider."""
...
START_URLS: List[str] = [
    "https://developers.weixin.qq.com/doc/offiaccount/OA_Web_Apps/Wechat_Open_Capability.html",
]
...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "developers_records".replace("-", "_")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for WeChat Open Platform Official Documentation")
