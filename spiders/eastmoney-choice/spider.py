#!/usr/bin/env python3
"""东方财富 Choice 金融终端 Scrapling Spider."""
...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "eastmoney-choice_records".replace("-", "_")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for 东方财富 Choice 金融终端")
