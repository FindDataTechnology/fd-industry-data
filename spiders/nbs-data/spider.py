#!/usr/bin/env python3
"""https://data.stats.gov.cn Scrapling Spider."""
...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "nbs-data_records".replace("-", "_")
...
def run_spider(urls: Optional[List[str]] = None, save_results: bool = True) -> List[Dict[str, Any]]:
    ...
    logger.info("Score priority: HIGH ({}))".format(100))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for https://data.stats.gov.cn")
