#!/usr/bin/env python3
"""
World Steel Association Spider - Scraping Implementation
...
logger = logging.getLogger("worldsteelassociation")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "worldsteelassociation.db"
