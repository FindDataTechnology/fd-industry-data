# GitHub China Topics Spider

Scrapling-based spider for GitHub China Topics (https://github.com/topics/china)
...
```bash
python spider.py --urls https://github.com/topics/china
```
