# NBS Data Query Portal Spider

**Target**: [http://www.stats.gov.cn/sj/](http://www.stats.gov.cn/sj/)  
**Score**: 95/100 - High-priority source

## What This Extracts
- Primary market data from NBS Data Query Portal
...
```bash
cd /Users/chengsishi/finddata/fd-industry-data/spiders/nbs-query
