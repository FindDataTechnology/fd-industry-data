#!/usr/bin/env python3
"""
CME Group Agriculture Spider - Scraping Implementation
...
logger = logging.getLogger("cmegroupagriculture")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "cmegroupagriculture.db"
