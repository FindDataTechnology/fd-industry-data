#!/usr/bin/env python3
"""TrendForce Market Intelligence Scrapling Spider."""
...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "trendforce_records".replace("-", "_")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for TrendForce Market Intelligence")
