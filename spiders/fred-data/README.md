# FRED Economic Data Spider

Automated data collection for FRED Economic Data.
...
├── data/
│   └── fred-data.db          # SQLite database
└── output/
    ├── fred-data_items.jsonl        # Streaming JSONL
    └── fred-data_complete.json       # Consolidated export
```
...
1. Verify URL accessibility:
   ```bash
   curl -I https://data.fred.stlouisfed.org/
   ```
...
|----------|---------|-------------|
| DB_PATH | ./data/fred-data.db | Custom database path |
...
*Generated by FindData DaaS • Score: 91/100 • Status: Ready for deployment*
