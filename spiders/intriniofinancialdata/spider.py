#!/usr/bin/env python3
"""
Intrinio Financial Data Spider - Scraping Implementation
...
logger = logging.getLogger("intriniofinancialdata")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "intriniofinancialdata.db"
