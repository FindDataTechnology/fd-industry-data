#!/usr/bin/env python3
"""Awesome Chinese API Scrapling Spider."""
...
START_URLS: List[str] = [
    "https://github.com/awesome-chinese-api/awesome-chinese-api",
]
...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    for key, value in sample.items():
        ...
        placeholders.append("?")
    table_name = "awesome_chinese_api_records"
...
def parse_response(response: Response) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        links = response.css("a.Link--primary")
        for link in links:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for Awesome Chinese API")
