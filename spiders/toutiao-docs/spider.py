...
def save_to_sqlite(records: List[Dict[str, Any]]) -> None:
    ...
    table_name = "toutiao-docs_records".replace("-", "_")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrapling spider for 今日头条API技术文档")
