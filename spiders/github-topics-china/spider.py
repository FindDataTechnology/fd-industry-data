...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "github-topics-china.db")
...
NAME = "github-topics-china"

class GithubtopicschinaSpider(Spider):
    name = "github-topics-china"
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS github-topics-china_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO github-topics-china_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM github-topics-china_data")
...
def run_github_topics_china(urls=None, save=True):
    """Run the github-topics-china spider. Returns True on success."""
    spider = GithubtopicschinaSpider()
...
if __name__ == "__main__":
    ...
    spider_instance = GithubtopicschinaSpider()
