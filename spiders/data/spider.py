...
class DataSpider(Spider):
    ...
    def _save_sqlite(self, item):
        ...
        try:
            ...
            create_sql = f"""CREATE TABLE IF NOT EXISTS data_data (
            ...
            insert_sql = f"INSERT OR IGNORE INTO data_data ({', '.join(cols)}) VALUES ({placeholders})"
    ...
    def _export(self):
        ...
        cursor = conn.cursor()
        cursor.execute(f"SELECT * FROM data_data")
...
def run_data(limit: int | None = None) -> list[dict]:
