#!/usr/bin/env python3
"""
Health Commission Spider - Scraping Implementation
...
logger = logging.getLogger("healthcommission")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "healthcommission.db"
