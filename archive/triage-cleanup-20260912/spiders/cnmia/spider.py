...
def run_cnmia(limit: int = 100) -> list[dict]:
    """Entry point for fd-open-data-protocol dispatch."""
    results = get_cnmia_data(include_production=True, include_trade=True, include_prices=True, include_reports=True, include_news=True)
    items = []
