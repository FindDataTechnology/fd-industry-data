#!/usr/bin/env python3
"""
Kaggle Zhihu Datasets Spider - Scraping Implementation
https://www.kaggle.com/search?q=zhihu+dataset
...
logger = logging.getLogger("kagglezhihudatasets")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "kagglezhihudatasets.db"
