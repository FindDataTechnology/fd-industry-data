#!/usr/bin/env python3
"""
NBS Data Query Portal Spider - Scraper
http://www.stats.gov.cn/sj/
Score: 95/100

Data Coverage: Market data and industry analytics from NBS Data Query Portal
...
logger = logging.getLogger("nbs-query")

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data"
OUTPUT_DIR = BASE_DIR / "output"
DB_PATH = DATA_DIR / "nbs-query.db"

TARGET_URLS = ["http://www.stats.gov.cn/sj/"]
...
def get_' + slug + '_data():
    ...
    logger.info("Starting %s data fetch", "NBS Data Query Portal")
